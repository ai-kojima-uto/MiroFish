  ...
  <div class="graph-panel">
    <div class="panel-header">
      ...
      <div class="header-tools">
        <button class="tool-btn" @click="$emit('refresh')" :disabled="loading" title="グラフを更新">
          <span class="icon-refresh" :class="{ 'spinning': loading }">↻</span>
          <span class="btn-text">Refresh</span>
        </button>
        <button class="tool-btn" @click="$emit('toggle-maximize')" title="最大化/元に戻す">
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? 'GraphRAG長短期記憶をリアルタイム更新中' : 'リアルタイム更新中...' }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">まだ一部のコンテンツを処理中です。後で手動でグラフを更新してください</span>
          <button class="hint-close-btn" @click="dismissFinishedHint" title="ヒントを閉じる">
      ...
      <div v-else class="graph-state">
        ...
        <p class="empty-text">オントロジー生成を待機中...</p>
      </div>
    </div>
